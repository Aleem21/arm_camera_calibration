...
% 
%     gHc = handEye2(bHg, cHw)
% 
%     bHg - pose of gripper relative to the robot base..
%           (Gripper center is at: g0 = bHg * [0;0;0;1] )
...
%     cHw - pose of world (calibratino pattern) relative to the camera  
...
%
% Notation: cHw - pose of camera frame (c) in the world (w) coordinate system
